...
var dataPath = path_1.default.join(__dirname, "..", "data", "accounts.json");
app.get("/", function (_req, res) {
    res.send("Welcome to the Bank Simulation Backend!");
});
// GET all accounts
app.get("/accounts", function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, promises_1.default.readFile(dataPath, "utf-8")];
            case 1:
                data = _a.sent();
